...
@Component({
  ...
  templateUrl: 'create-visit-dialog.html',
})
export class CreateVisitDialogComponent implements OnInit {
  ...
  constructor(private icpcService: IcpcService, public dialogRef: MdDialogRef<CreateVisitDialogComponent>,
